                        ...
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center;">نام  آدرس</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                 ...
                                 <td style="text-align: center;"><?=$row->publisher_address?></td>
                                ...
                                <a class="btn btn-circle btn-icon-only btn-danger" href="javascript:void(0);" onclick="delete_record(<?=$row->publisher_id?>);" data-toggle="tooltip" data-placement="top" title="حذف"><span class="fa fa-trash-o"></a>
                                </td>
                                </tr>
                              <?php }?>
                            </tbody>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">اضافه نمودن  پابلیشر</h4>
            </div>
            <div class="modal-body">
                <form method="post" action="<?=base_url()?>index.php/publisherController/addPublisher">
                    <div class="form-group">
                        <div class="form-group form-md-line-input col-md-4 has-success">
                            <input  type="text" name="name" class="form-control" id="form_control_1" placeholder="نام پابلیشر"  required>
                            <label for="form_control_1">نام  پابلیشر</label>
                        </div>
                         <div class="form-group form-md-line-input col-md-4 has-success">
                            <input  type="text" name="publisher_address" class="form-control" id="form_control_1" placeholder="آدرس"  required>
                            <label for="form_control_1">آدرس</label>
                        </div>
                        <br><br>
                    </div>
            </div>
            ...
            <div class="modal-body">
                <form method="post" action="<?=base_url()?>index.php/publisherController/updatePublisher">
                    <div class="form-group">
                        ...
                        <div class="form-group form-md-line-input col-md-4 has-success">
                            <input  type="text" name="publisher" class="form-control" id="publisher" placeholder="کتگوری"  required>
                            <label for="form_control_1">نام پابلیشر</label>
                           
                        </div>
                         <div class="form-group form-md-line-input col-md-4 has-success">
                            <input  type="text" name="address" class="form-control" id="address" placeholder="کتگوری"  required>
                             <label for="form_control_1">آدرس</label>
                         </div>
                        <br><br>
                    </div>
...
<script type="text/javascript">
    ...
    function delete_record(id){
        ...
        if(r==true)
            window.location=url+"index.php/publisherController/deletePublisher?id="+id;
        else
            return false;
    }
</script>
        ...
        <div id="success" class="modal fade " role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a href="<?php echo base_url()?>index.php/publisherController/index" class="btn btn-primary">بستن</a>
                    </div>
                </div>
            </div>
        </div>
