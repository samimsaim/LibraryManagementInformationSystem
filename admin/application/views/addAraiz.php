...
<div class="page-content-wrapper">
            ...
            <div class="portlet-body form" style="margin-right: 20px;">
              ...
              <?php }?>
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_ejrat)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="ejrat" value="<?php if (!empty($Field_data['valuemNumber'])) echo $Field_data['valuemNumber']; ?>" placeholder="">
                                <div class="form-control-focus"> </div>
    ...
    <div class="row">
                           <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_sadra_number)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="sadra_number" value="<?php if (!empty($Field_data['price'])) echo $Field_data['price']; ?>" placeholder="">
                                <div class="form-control-focus"> </div>
