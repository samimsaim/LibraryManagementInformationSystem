    ...
    <div class="page-content">
        ...
        <div class="portlet light ">
            ...
            <div class="portlet-body form" style="margin-right: 20px;">
                <form class="form-horizontal" method="post" action="<?=base_url()?>index.php/bookController/checkAddBook" enctype="multipart/form-data">
                    <div class="form-body">
                    <div class="row">
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_record_number)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="recordNumber" value="<?php if (!empty($Field_data['recordNumber'])) echo $Field_data['recordNumber']; ?>" placeholder="۴۳۳">
                    ...
                    <div class="row">
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_title)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="title" value="<?php if (!empty($Field_data['id'])) echo $Field_data['title']; ?>" placeholder="ریاضیات">
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_edition)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="edition" value="<?php if (!empty($Field_data['edition'])) echo $Field_data['edition']; ?>" placeholder="ویرایش">
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_publisher)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="publisher" onchange="getDepartment()" id="fac">
                                    <option <?php if(!empty($Field_data['publisher']) && $Field_data['publisher'] == 0) echo ' selected '?> value="0">ناشر</option>
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_valuem)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="valuemNumber" value="<?php if (!empty($Field_data['valuemNumber'])) echo $Field_data['valuemNumber']; ?>" placeholder="۷۸">
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_number_of_page)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="page" value="<?php if (!empty($Field_data['id'])) echo $Field_data['page']; ?>" placeholder="۸۰">
                                <div class="form-control-focus"> </div>
                       ...
                       <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_percurement)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                 <select class="form-control" name="procurement" >
                                    <option <?php if(!empty($Field_data['procurement']) && $Field_data['procurement'] == 0) echo ' selected '?> value="0">نوعیت خریداری</option>
                    ...
                    <div class="row">
                       <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_procurement)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                               <select class="form-control" name="category">
                                    <option <?php if(!empty($Field_data['province']) && $Field_data['province'] == 0) echo ' selected '?> value="0">کتگوری</option>
                      ...
                      <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_price)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="price" value="<?php if (!empty($Field_data['price'])) echo $Field_data['price']; ?>" placeholder="۵۰۰">
                                <div class="form-control-focus"> </div>
