                ...
                <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th style="text-align: center;">نام  پابلیشر</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                 <td style="text-align: center;"><?=$row->procurement_id?></td>
                                 <td style="text-align: center;"><?=$row->procurement_name?></td>
                                ...
                                <a type="button" class="btn btn-circle btn-icon-only btn-success editbtn" ><span class="fa fa-pencil"></a>
                                  <a class="btn btn-circle btn-icon-only btn-danger" href="javascript:void(0);" onclick="delete_record(<?=$row->procurement_id?>);" data-toggle="tooltip" data-placement="top" title="حذف"><span class="fa fa-trash-o"></a>
                                </td>
                                </tr>
                              <?php }?>
                            </tbody>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">اضافه نمودن  تمویل کننده</h4>
            </div>
            <div class="modal-body">
                <form method="post" action="<?=base_url()?>index.php/ProcurmentController/addProcurment">
                    <div class="form-group">
                        <div class="form-group form-md-line-input col-md-4 has-success">
                            <input  type="text" name="name" class="form-control" id="form_control_1" placeholder="نام  تمویل کننده"  required>
                            <label for="form_control_1">نام  تمویل کننده</label>
                        </div>
                        <br><br>
                    </div>
            </div>
...
<div class="modal fade" id="editmodal" role="dialog">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" align="right" data-dismiss="modal" >&times;</button>
                <h4 class="modal-title">ویرایش تمویل کننده</h4>
            </div>
            <div class="modal-body">
                <form method="post" action="<?=base_url()?>index.php/ProcurmentController/updateProcurment">
                    <div class="form-group">
                        <input type="hidden" name="procurement_id" id="procurement_id">
                        <div class="form-group form-md-line-input col-md-4 has-success">
                            <input  type="text" name="procurment" class="form-control" id="procurement_name" placeholder="کتگوری"  required>
                            <label for="form_control_1">نام تمویل کننده</label>
                        </div>
                        <br><br>
                    </div>
...
<script type="text/javascript">
    ...
    function delete_record(id){
        ...
        if(r==true)
            window.location=url+"index.php/ProcurmentController/deleteProcurement?id="+id;
        else
            return false;
    }
</script>
        ...
        <div id="success" class="modal fade " role="dialog">
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <a href="<?php echo base_url()?>index.php/ProcurmentController/index" class="btn btn-primary">بستن</a>
                    </div>
                </div>
            </div>
        </div>
