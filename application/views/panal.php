                ...
                <div class="portlet light ">
                    ...
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            ...
                            <tbody>
                                <?php foreach ($panal as $row) {?>
                                    <tr>
                                       <td style="text-align: center;"><?=$row->wp_id?></td>
                                        <td style="text-align: center;"><?=$row->wp_name?></td>
                                        <td style="text-align: center;"><?=$row->mag_no?>
                                        
                                        <td style="text-align: center;">
                                        <a type="button" class="btn btn-circle btn-icon-only btn-success editbtn" ><span class="fa fa-pencil"></a>
                                          <a class="btn btn-circle btn-icon-only btn-danger" href="javascript:void(0);" onclick="delete_record(<?=$row->wp_id?>);" data-toggle="tooltip" data-placement="top" title="حذف"><span class="fa fa-trash-o"></span></a>
                                        </td>
                                    </tr>
                                <?php }?>
                            </tbody>
