                ...
                <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th style="text-align: center;">نام  مترجم ها</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                 <td style="text-align: center;"><?=$row->translator_id?></td>
                                 <td style="text-align: center;"><?=$row->translator_name?></td>
                                ...
                                <a class="btn btn-circle btn-icon-only btn-danger" href="javascript:void(0);" onclick="delete_record(<?=$row->translator_id?>);" data-toggle="tooltip" data-placement="top" title="حذف"><span class="fa fa-trash-o"></a>
                                </td>
                                </tr>
                              <?php }?>
                            </tbody>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">اضافه نمودن  مترجم </h4>
            </div>
            <div class="modal-body">
                <form method="post" action="<?=base_url()?>index.php/translatorController/addTranslator">
                    <div class="form-group">
                        <div class="form-group form-md-line-input col-md-4 has-success">
                            <input  type="text" name="name" class="form-control" id="form_control_1" placeholder="نام  مترجم"  required>
                            <label for="form_control_1">نام  مترجم</label>
                        </div>
                        <br><br>
                    </div>
            </div>
...
<div class="modal fade" id="editmodal" role="dialog">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" align="right" data-dismiss="modal" >&times;</button>
                <h4 class="modal-title">ویرایش مترجم</h4>
            </div>
            <div class="modal-body">
                <form method="post" action="<?=base_url()?>index.php/translatorController/updatetranslator">
                    <div class="form-group">
                        <input type="hidden" name="translator_id" id="translator_id">
                        <div class="form-group form-md-line-input col-md-4 has-success">
                            <input  type="text" name="translator_name" class="form-control" id="translator_name" placeholder="کتگوری"  required>
                            <label for="form_control_1">نام متر جم</label>
                        </div>
                        <br><br>
                    </div>
            </div>
...
<script >
   $(document).ready(function(){
     $('.editbtn').on('click',function(){
        ...
        $('#translator_id').val(data[0]);
        $('#translator_name').val(data[1]);
...
<script type="text/javascript">
    ...
    function delete_record(id){
        ...
        if(r==true)
            window.location=url+"index.php/translatorController/deleteTranslator?id="+id;
        else
            return false;
    }
</script>
