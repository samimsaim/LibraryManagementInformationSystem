...
<div class="page-content">
        ...
        <div class="portlet light ">
                ...
                <div class="actions">
                    <a class="btn btn-circle btn-green green-meadow" href="<?=base_url()?>index.php/ahkamController/index" style="font-size: 16px;">
                        <i class="fa fa-share"></i>برگشت</a>
            ...
            </div>               <?php foreach($ahkam as $hukom){} ?>
                                         <form class="form-horizontal" method="post" action="<?=base_url()?>index.php/ahkamController/checkEditHukm" enctype="multipart/form-data">
                                            <div class="form-body">
                                             <div class="row">
                                      ...
                                      <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_date)) echo 'has-error' ?>">
                                           ...
                                           <div class="col-md-9">
                                           <input type="date" style="text-align: right;" class="form-control" name="date" value="<?=$hukom->date?>" placeholder="۱۳۹۸/۳/۲">
                                              <div class="form-control-focus"></div>
                    ...
                    <div class="row">
                       <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_khulasMatlab)) echo 'has-error' ?>">
                            <label class="col-md-3 control-label" style="font-weight: bold;">خلاصخ مطلب*</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="khulasMatlab" value="<?=$hukom->khulas_matlab?>" placeholder="">
                                <div class="form-control-focus"></div>
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_mursal)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="mursal" value="<?=$hukom->mursal?>" placeholder="">
                                <div class="form-control-focus"> </div>
              ...
              <?php }?>
                       ...
                       <div class="row">                                 
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_mursalAlai)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="mursalAlai" value="<?=$hukom->mursal_elai?>" placeholder="">
                                <div class="form-control-focus"> </div>
                               ...
                               <div class="row">
                                      <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_mulahezat)) echo 'has-error' ?>">
                                            <label class="col-md-3 control-label" style="font-weight: bold;">ملاحظات*</label>
                                                <div class="col-md-9">
                                                        <input type="text" class="form-control" name="mulahezat" value="<?=$hukom->mulahezat?>" placeholder="">
                                                        <div class="form-control-focus"></div>
                                                ...
                                                <div class="row">
                                                   <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_bakhsheTahrerat)) echo 'has-error' ?>">
                                                       ...
                                                       <div class="col-md-9">
                                                           <input type="text" class="form-control" name="bakhsheTahrerat" value="<?=$hukom->tahrerat?>" placeholder="">
                                                           <div class="form-control-focus"></div>
                      ...
                      <div class="row">
                       <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_dosyaArchive)) echo 'has-error' ?>">
                         ...
                         <input type="hidden" name="id" value="<?=$hukom->hukom_id ?>">
                      </div>
