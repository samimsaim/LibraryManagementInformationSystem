                ...
                <form class="form-horizontal" method="post" action="<?=base_url()?>index.php/studentController/checkEditStudent" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_name)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="name" value="<?=$row->name?>" placeholder="محمود">
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_father_name)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="fatherName" value="<?=$row->f_name?>" placeholder="احمد">
                                <div class="form-control-focus"></div>
                    ...
                    <div class="row">
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_id)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="id" value="<?=$row->id_no?>" placeholder="۸۹۸۷۶">
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_date)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="date" value="<?=$row->date?>" placeholder="۱۳۹۳/۳/۶">
                                <div class="form-control-focus"> </div>
                         ...
                         <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_faculty)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="faculty" onchange="getDepartment()" id="fac">
                                    <option <?php if(!empty($Field_data['faculty']) && $Field_data['faculty'] == 0) echo ' selected '?> value="0"><?=$facu->faculty_name?></option>
                                    <?php foreach ($fac as $fac) { ?>
                                    <option <?php if(!empty($Field_data['faculty']) && $Field_data['faculty'] == $fac->faculty_id) echo ' selected '?> value="<?=$fac->faculty_id?>"><?=$fac->faculty_name?></option>
                                    <?php }?>
                                </select>
                                <div class="form-control-focus"> </div>
                         ...
                         <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_department)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" name="department" id="dep">
                                    <option <?php if(!empty($Field_data['dis']) && $Field_data['dis'] == 0) echo ' selected '?> value="<?=$depa->department_id?>"><?=$depa->department_name?></option>
                                </select>
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_current_resident)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control"  name="currentResident"  placeholder="کاپیسا"  value="<?=$row->current_resident?>">
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_original_resident)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="originalResident" value="<?=$row->original_resident?>" placeholder="کوهستان">
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_phone)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="phone" value="<?=$row->phone_no?>" placeholder="۰۷۸۹۵۶۸۹۴۷">
                                <div class="form-control-focus"> </div>
                        ...
                        <div class="form-group form-md-line-input col-md-6 <?php if (!empty($error_email)) echo 'has-error' ?>">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="email" value="<?=$row->email_address?>" placeholder="kpu@gmail.com">
                                <div class="form-control-focus"> </div>
