                    ...
                    <div class="table-toolbar">
                        <div class="row">
                            <div class="col-md-6" style=" margin-bottom: -8px;">
                                <div class="btn-group">
                                    <a href="<?php echo base_url()?>index.php/ahkamController/addmAhkam"  class="btn btn-circle green-meadow">اضافه نمودن<i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                            <div class="col-md-6">
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center;"> قید وارده /صادره</th>
                            ...
                            <?php foreach ($data as $row) { ?>
                                <tr>
                                    ...
                                    foreach ($result as $value) {
                                     ?>
                                    <td style="text-align: center;"><?=$value->nawyat?></td>
                                     <td style="text-align: center;"><?=$value->qaid_warda; ?></td>
                                      <?php }?>
                                      <td style="text-align: center;"><?=$row->khulas_matlab?></td>
                                      <td style="text-align: center;"><?=$row->mulahezat?></td>
                                      <td style="text-align: center;">
                                        <a href="<?=base_url()?>index.php/ahkamController/ahkamDetail?id=<?=$row->hukom_id?>" class="btn btn-circle btn-icon-only  green-jungle"><span class="glyphicon glyphicon-eye-open "></a>
                                       <a class="btn btn-circle btn-icon-only btn-success" href="<?=base_url()?>index.php/ahkamController/editAhkam?id=<?=$row->hukom_id ?>"><span class="fa fa-pencil"></a>
                                        <a class="btn btn-circle btn-icon-only btn-danger" href="javascript:void(0);" onclick="delete_record(<?=$row->hukom_id?>);" data-toggle="tooltip" data-placement="top" title="حذف"><span class="fa fa-trash-o"></span></a>
                                       </td>
                                   </tr>
                               <?php }?>
                           </tbody>
